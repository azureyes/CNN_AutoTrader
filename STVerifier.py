...
for code in TEST_CODES:
    ...
    print('Benchmark Profit Per Day : %0.2f%%' %((benchmark_netvalue-1)/TOTAL_COUNT*100.0))
    ...
    str_benchmarkProfitPerDay = '%0.2f%%' %((benchmark_netvalue-1)/TOTAL_COUNT*100.0)
    str_profitPerDay = '%0.2f%%' %((simtrade_netvalue-1)/TRADE_COUNT*100.0)
    
    datalist = [str_code, str_accuracy, str_proandlossRatio, str_hitRate, str_benchmarkValue, str_simtradeValue, str_benchmarkProfitPerDay, str_profitPerDay]
